    ...
    <>
      {editor ? (
        ...
        >
          ...
          <div className='p-2 outline-none min-h-[120px] bg-background text-foreground px-4 prose prose-h1:my-1 prose-h2:my-1 prose-h3:my-1 prose-h4::my-1 prose-h5:my-1 prose-h6:my-1 prose-p:my-1 prose-ul:my-1 prose-ol:my-1 prose-blockquote:my-1'>
